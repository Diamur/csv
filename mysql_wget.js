...
const domen     = "electronics-vista.ru";
const iblock_id = 23;
...
const query_b_file = query.b_file(iblock_id);
var loop = 0; 
...
return new Promise((resolve, reject) => {
    wget({
        ...
        timeout: 4000       // duration to wait for request fulfillment in milliseconds, default is 2 second
    },
